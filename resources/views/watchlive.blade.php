...
<section class="bg-primary" id="x">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <h2 class="section-heading">Watch</h2>
                <br>
                <p class=""> <h1><i class="fa fa-camera" aria-hidden="true"></i></h1>
                <br>
                No! Attend the meet you anti-social person...</p>
            </div>
        </div>
    <div>
</section>
...
<section class="" id="live">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <a href="/" class="btn btn-primary btn-xl page-scroll">Go back</a>
            </div>
        </div>
    </div>
</section>
